...
@NamedQueries({
    ...
    @NamedQuery(name = "UserAuth.findByEnabled", query = "SELECT u FROM UserAuth u WHERE u.enabled = :enabled")})
public class UserAuth implements Serializable {
    ...
    public UserAuth(Integer id) {
        this.id = id;
    }

    public UserAuth(Integer id, String username, String password, boolean enabled) {
        this.id = id;
    ...
    public String toString() {
        return "com.gmail.soch.sebastian.flashcards.entity.UserAuth[ id=" + id + " ]";
    }
